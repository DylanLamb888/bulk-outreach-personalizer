...
A conversational message must still be truthful: do not imply that you are a
colleague, have met, already researched an asset, or hold buyers ready to send.
...
> p.s. if this isn’t something you’re interested in, just reply "no thanks" and I’ll take you off my list.
...
The rejected line sounds like an advertisement's headline and response. Avoid
...
actually honour; exporting copy does not implement that action.
